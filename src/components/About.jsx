      ...
      >
        ...
        <div className="flex flex-col items-center md:items-start mt-10 text-gray-600">
          ...
          <p className="my-10 max-w-lg">
            With over a decade of expertise, we have successfully delivered
            numerous projects, totaling millions of square feet. Our dedication
            continues through multiple ongoing ventures, showcasing our
